...
@expose_substitution("struct-dump")
class StructDump(Substitution):
    ...
    def perform(self, context: LaunchContext) -> Any:
        ...
        value = struct_get_field(context.launch_configurations, field)
        return safe_dump(value, default_flow_style=True)
